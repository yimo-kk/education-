  ...
  <div class="table">
    <div class="form_box">
      <div class="search-con search-con-top">
        课程名称:
        <Input clearable placeholder="课程名称" class="search-input" v-model="name" />状态:
        <Select v-model="state" class="search-col">
...
<script>
import "./index.less";
import { getOnlinePage, courseOnlineUp, courseOnlineDown } from "@/api/course";
