  ...
  <div class="table">
    <div class="form_box">
      <div class="search-con search-con-top">
        订单编号:
        <Input clearable placeholder="所属用户名称" class="search-input" v-model="orderNo" />&nbsp;
        买家手机号:
        <Input clearable placeholder="手机号" class="search-input" v-model="buyUserPhone" />下单时间:
        <DatePicker
          type="date"
...
<script>
import "./index.less";
import { getOnlineCourseOrderPage } from "@/api/courseOrder";
...
export default {
  ...
  methods: {
    handleDataList() {
      ...
      getOnlineCourseOrderPage(param)
        .then(res => {
